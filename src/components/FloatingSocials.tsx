  ...
  return (
    <div className="fixed right-5 top-1/2 -translate-y-1/2 z-[999] flex flex-col gap-4 print:hidden">
      ...
      >
        ...
        <svg className="w-6 h-6 fill-current text-slate-900 relative z-10" viewBox="0 0 448 512" aria-hidden="true">
      ...
      >
        ...
        <svg className="w-5.5 h-5.5 text-slate-900 stroke-current fill-none relative z-10" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
